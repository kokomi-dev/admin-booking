...
const SignIn = () => {
  ...
  const mutationLogin = useMutation({ mutationFn: reqlogin });

  const onFinish = async (data) => {
    mutationLogin.mutate(data, {
      onSuccess: async (res) => {
        if (res.data.code === 404) {
          MessNotify.error('Có lỗi xảy ra!');
        } else if (res.data.code === 403) {
          MessNotify.warning('Tài khoản của bạn đang chờ phê duyệt');
        } else {
  ...
  return (
    <>
      ...
      <div className="max-w-[1100px] mx-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="w-full grid md:grid-cols-1 lg:grid-cols-2 gap-x-4">
          <div className=" w-full xl:block xl:w-full">
            <div className="py-4 px-6 text-center">
              <Link className="mb-5.5 inline-block w-[10rem] h-[10rem]" to="/">
                <img className="hidden dark:block" src={Logo} alt="Logo" />
                <img className="dark:hidden" src={LogoDark} alt="Logo" />
              </Link>

              <p className="2xl:px-20">
                Trang dành cho admin, doanh nghiệp đăng ký với KoKoTravel
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              >
                ...
                <h3 className="text-end">Quên mật khẩu?</h3>
