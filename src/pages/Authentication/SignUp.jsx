...
const SignUp = () => {
  ...
  const mutationRegister = useMutation({ mutationFn: reqRegister });
  const onFinish = async (data) => {
    if (data.password !== data.confirmPassword) {
      return MessNotify.warning('Mật khẩu không khớp');
    } else {
      mutationRegister.mutate(
        {
          ...
          groupId: [2, 6],
          infoUnit: {
            activityArena: data.activityArena,
            unitName: data.unitName,
            unitAddress: data.unitAddress,
            unitTaxCode: data.unitTaxCode,
          },
        },
        {
          onSuccess: async (res) => {
            if (res.code === 404) {
              MessNotify.error('Mật khẩu hoặc tài khoản chưa chính xác');
            } else {
              MessNotify.success('Tạo tài khoản thành công');
  ...
  return (
    <>
      ...
      <div className="max-w-[1100px] mx-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="grid md:grid-cols-1 lg:grid-cols-[40%,60%] gap-x-4">
          <div className="hidden w-full lg:block xl:w-full">
          ...
          <div className="w-full  border-stroke dark:border-strokedark xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">
                Đăng ký và đợi duyệt từ quản trị viên chúng tôi
              </span>
              ...
              >
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-x-4">
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: 'vui lòng nhập dịa chỉ đơn vị!',
                      },
                    ]}
                  >
                    <Input type="text" />
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: 'vui lòng nhập mã số thuế đơn vị!',
                    },
                  ]}
                >
                  <Input type="text" />
                ...
                <Form.Item
                  label="Lựa chọn khu vực hoạt động"
                  name="activityArena"
                  rules={[
                    {
                      required: true,
                      message: 'vui lòng chọn ít nhât 1 nơi hoạt động!',
                    },
                  ]}
                >
                  <Select
                ...
                <span className="text-red-500 mb-2">
                  Email này sẽ là email chính để nhận các thông tin
                </span>
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-x-4">
                  <Form.Item
                    label="Email"
                  ...
                  <Form.Item
                    ...
                    name="numberPhone"
                    rules={[
                      { required: true, message: 'vui lòng nhập số ĐT!' },
                    ]}
                  >
                    <Input type="number" />
                  </Form.Item>
                ...
                <h3 className="text-end">Điều khoản dịch vụ?</h3>
                <div>
