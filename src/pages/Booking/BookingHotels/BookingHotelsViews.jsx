...
const BookingHotelViews = ({
  ...
  const fetchStatistics = async (params) => {
    ...
    try {
      const res = await getTotalBookingHotel(params);
  ...
  console.log(statsFilter, statsData.chartData);
...
//            text={
//              selectedBooking?.isSuccess ? 'Đã thanh toán' : 'Chờ thanh toán'
//            }
//          />
//        </div>
//      </div>
...
//          {selectedBooking.infoHotel?.name || 'Không có thông tin'}
//        </Descriptions.Item>
//        <Descriptions.Item label="Slug đặt phòng">
//          {selectedBooking.slugBooked || 'Không có thông tin'}
//        </Descriptions.Item>
//        <Descriptions.Item label="Địa chỉ">
//          {selectedBooking.infoHotel?.address || 'Không có thông tin'}
//        </Descriptions.Item>
//      </Descriptions>
...
//          <Tag
//            color={
//              selectedBooking.paymentMethod === 'zalopay' ? 'blue' : 'purple'
//            }
//          >
...
//          {formatDate(selectedBooking?.dateFrom)}
//        </Descriptions.Item>
//        <Descriptions.Item label="Ngày trả phòng">
//          {formatDate(selectedBooking?.dateTo)}
//        </Descriptions.Item>
...
//        className="mb-4"
//      >
//        <Descriptions.Item label="Số lượng phòng" span={3}>
//          {selectedBooking.numberOfTicketsBooked?.numberRoom || 0} phòng
//        </Descriptions.Item>
//        <Descriptions.Item label="Người lớn" span={3}>
//          {selectedBooking.numberOfTicketsBooked?.adult || 0} người
//        </Descriptions.Item>
//        <Descriptions.Item label="Trẻ em" span={3}>
//          {selectedBooking.numberOfTicketsBooked?.children || 0} bé
//        </Descriptions.Item>
//      </Descriptions>
//    </div>
//  </Modal>;
